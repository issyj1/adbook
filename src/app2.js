...
<MyMasonryComponent></MyMasonryComponent>
      ...
      <img className="ij" src="/adbook/img/Assets/made.png" alt="ij" />

      <div className="overlay2">

<div ref={ijRef} className="background-ij">IJ</div>
</div>
<img className="img4" src="/adbook/img/tiger.png" alt="Me" />
...
{/* Example: slow-scrolling photos */}
    ...
    <img className="img3" src="/adbook/img/shoes3.jpg" alt="Me" />
